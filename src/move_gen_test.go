	...
	tests := []struct {
		...
		{STARTING_FEN, WHITE, 20,
			[]MoveUnpacked{
				...
				{G1, H3, WHITE_PAWN, 0, QUIET},
				{B1, A3, WHITE_PAWN, 0, QUIET},
				{B1, C3, WHITE_PAWN, 0, QUIET},
			},
		},
		{STARTING_FEN, BLACK, 20,
			[]MoveUnpacked{
				{A7, A6, WHITE_PAWN, 0, QUIET},
				{B7, B6, WHITE_PAWN, 0, QUIET},
				{C7, C6, WHITE_PAWN, 0, QUIET},
				{D7, D6, WHITE_PAWN, 0, QUIET},
				{E7, E6, WHITE_PAWN, 0, QUIET},
				{F7, F6, WHITE_PAWN, 0, QUIET},
				{G7, G6, WHITE_PAWN, 0, QUIET},
				{H7, H6, WHITE_PAWN, 0, QUIET},
				{A7, A5, WHITE_PAWN, 0, DOUBLE_PAWN_PUSH},
				{B7, B5, WHITE_PAWN, 0, DOUBLE_PAWN_PUSH},
				{C7, C5, WHITE_PAWN, 0, DOUBLE_PAWN_PUSH},
				{D7, D5, WHITE_PAWN, 0, DOUBLE_PAWN_PUSH},
				{E7, E5, WHITE_PAWN, 0, DOUBLE_PAWN_PUSH},
				{F7, F5, WHITE_PAWN, 0, DOUBLE_PAWN_PUSH},
				{G7, G5, WHITE_PAWN, 0, DOUBLE_PAWN_PUSH},
				{H7, H5, WHITE_PAWN, 0, DOUBLE_PAWN_PUSH},
				{G8, F6, WHITE_PAWN, 0, QUIET},
				{G8, H6, WHITE_PAWN, 0, QUIET},
				{B8, A6, WHITE_PAWN, 0, QUIET},
...
func TestGeneratePawnMoves(t *testing.T) {
	tests := []struct {
		...
		{"rnbqkb1r/pppp2Pp/4pn2/8/8/8/PPPP1PPP/RNBQKBNR w KQkq - 0 5", WHITE, G7, MAX_PAWN_MOVES,
			[]MoveUnpacked{
				{G7, F8, WHITE_PAWN, 0, KNIGHT_PROMOTION_CAPTURE},
				{G7, F8, WHITE_PAWN, 0, BISHOP_PROMOTION_CAPTURE},
				{G7, F8, WHITE_PAWN, 0, ROOK_PROMOTION_CAPTURE},
				{G7, F8, WHITE_PAWN, 0, QUEEN_PROMOTION_CAPTURE},
				...
				{G7, H8, WHITE_PAWN, 0, KNIGHT_PROMOTION_CAPTURE},
				{G7, H8, WHITE_PAWN, 0, BISHOP_PROMOTION_CAPTURE},
				{G7, H8, WHITE_PAWN, 0, ROOK_PROMOTION_CAPTURE},
				{G7, H8, WHITE_PAWN, 0, QUEEN_PROMOTION_CAPTURE},
			},
		},
		{"rnbqkb1Q/pp1p3p/4pn2/8/8/3B1N2/PpPP1PPP/RNBQ1RK1 b q - 1 9", BLACK, B2, 8,
			[]MoveUnpacked{
				{B2, A1, WHITE_PAWN, 0, KNIGHT_PROMOTION_CAPTURE},
				{B2, A1, WHITE_PAWN, 0, BISHOP_PROMOTION_CAPTURE},
				{B2, A1, WHITE_PAWN, 0, ROOK_PROMOTION_CAPTURE},
				{B2, A1, WHITE_PAWN, 0, QUEEN_PROMOTION_CAPTURE},
				{B2, C1, WHITE_PAWN, 0, KNIGHT_PROMOTION_CAPTURE},
				{B2, C1, WHITE_PAWN, 0, BISHOP_PROMOTION_CAPTURE},
				{B2, C1, WHITE_PAWN, 0, ROOK_PROMOTION_CAPTURE},
				{B2, C1, WHITE_PAWN, 0, QUEEN_PROMOTION_CAPTURE},
			},
		},
...
func TestGenerateKnightMoves(t *testing.T) {
	tests := []struct {
		...
		{"rnbqkbnr/ppp1p1pp/8/3p1p2/3N4/8/PPPPPPPP/RNBQKB1R w KQkq - 0 3", WHITE, D4, 6,
			[]MoveUnpacked{
				{D4, B3, WHITE_PAWN, 0, QUIET},
				{D4, B5, WHITE_PAWN, 0, QUIET},
				{D4, C6, WHITE_PAWN, 0, QUIET},
				{D4, E6, WHITE_PAWN, 0, QUIET},
				{D4, F5, WHITE_PAWN, 0, CAPTURE},
				{D4, F3, WHITE_PAWN, 0, QUIET},
			},
		},
		{"r1bqkbnr/ppp1p1pp/8/3p4/3n1p2/2N1P1P1/PPPPQP1P/R1B1KB1R b KQkq - 1 6", BLACK, D4, MAX_KNIGHT_MOVES,
			[]MoveUnpacked{
				...
				{D4, C6, WHITE_PAWN, 0, QUIET},
				{D4, E6, WHITE_PAWN, 0, QUIET},
				{D4, F5, WHITE_PAWN, 0, QUIET},
				{D4, F3, WHITE_PAWN, 0, QUIET},
				{D4, E2, WHITE_PAWN, 0, CAPTURE},
				{D4, C2, WHITE_PAWN, 0, CAPTURE},
			},
		},
	}
	for _, tt := range tests {
...
func TestGenerateBishopMoves(t *testing.T) {
	tests := []struct {
		...
		{"rnbqkbnr/pp1ppppp/8/2p5/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2", WHITE, F1, 5,
			[]MoveUnpacked{
				{F1, E2, WHITE_PAWN, 0, QUIET},
				{F1, D3, WHITE_PAWN, 0, QUIET},
				{F1, C4, WHITE_PAWN, 0, QUIET},
				{F1, B5, WHITE_PAWN, 0, QUIET},
				{F1, A6, WHITE_PAWN, 0, QUIET},
			},
		},
		{"rnbqkbnr/pp1pp1pp/5p2/2p5/2B1P3/8/PPPP1PPP/RNBQK1NR w KQkq - 0 3", WHITE, C4, 10,
			[]MoveUnpacked{
				{C4, B3, WHITE_PAWN, 0, QUIET},
				{C4, B5, WHITE_PAWN, 0, QUIET},
				{C4, A6, WHITE_PAWN, 0, QUIET},
				{C4, D3, WHITE_PAWN, 0, QUIET},
				{C4, E2, WHITE_PAWN, 0, QUIET},
				{C4, F1, WHITE_PAWN, 0, QUIET},
				{C4, D5, WHITE_PAWN, 0, QUIET},
				{C4, E6, WHITE_PAWN, 0, QUIET},
				{C4, F7, WHITE_PAWN, 0, QUIET},
				{C4, G8, WHITE_PAWN, 0, CAPTURE},
			},
		},
		{"rn2kbnr/p2qp1p1/1p1p1p1p/1bpBP3/7P/P5P1/1PPP1P1R/RNBQK1N1 w Qkq - 3 9", WHITE, D5, MAX_BISHOP_MOVES,
			[]MoveUnpacked{
				{D5, C6, WHITE_PAWN, 0, QUIET},
				{D5, B7, WHITE_PAWN, 0, QUIET},
				{D5, A8, WHITE_PAWN, 0, CAPTURE},
				{D5, E6, WHITE_PAWN, 0, QUIET},
				{D5, F7, WHITE_PAWN, 0, QUIET},
				{D5, G8, WHITE_PAWN, 0, CAPTURE},
				{D5, C4, WHITE_PAWN, 0, QUIET},
				{D5, B3, WHITE_PAWN, 0, QUIET},
				{D5, A2, WHITE_PAWN, 0, QUIET},
				{D5, E4, WHITE_PAWN, 0, QUIET},
				{D5, F3, WHITE_PAWN, 0, QUIET},
				{D5, G2, WHITE_PAWN, 0, QUIET},
				{D5, H1, WHITE_PAWN, 0, QUIET},
			}},
	}
	for _, tt := range tests {
		b, err := NewBoard(tt.fen)
...
func TestGenerateRookMoves(t *testing.T) {
	tests := []struct {
		...
		{"rnbqkbnr/2pppppp/8/8/8/R7/1PPPPPPP/1NBQKBNR w Kk - 2 5", WHITE, A3, MAX_ROOK_MOVES,
			[]MoveUnpacked{
				{A3, A1, WHITE_PAWN, 0, QUIET},
				{A3, A2, WHITE_PAWN, 0, QUIET},
				{A3, A4, WHITE_PAWN, 0, QUIET},
				{A3, A5, WHITE_PAWN, 0, QUIET},
				{A3, A6, WHITE_PAWN, 0, QUIET},
				{A3, A7, WHITE_PAWN, 0, QUIET},
				{A3, A8, WHITE_PAWN, 0, CAPTURE},
				{A3, B3, WHITE_PAWN, 0, QUIET},
				{A3, C3, WHITE_PAWN, 0, QUIET},
				{A3, D3, WHITE_PAWN, 0, QUIET},
				{A3, E3, WHITE_PAWN, 0, QUIET},
				{A3, F3, WHITE_PAWN, 0, QUIET},
				{A3, G3, WHITE_PAWN, 0, QUIET},
				{A3, H3, WHITE_PAWN, 0, QUIET},
			},
		},
	}
	for _, tt := range tests {
	...
	tests := []struct {
		...
		{"r2qk1r1/p1p3pp/np3p1n/3Q4/6bP/P5P1/1PP1PP1R/RNB1KBN1 w Qq - 1 10", WHITE, D5, MAX_QUEEN_MOVES,
			[]MoveUnpacked{
				...
				{D5, G2, WHITE_PAWN, 0, QUIET},
				{D5, H1, WHITE_PAWN, 0, QUIET},
				{D5, D1, WHITE_PAWN, 0, QUIET},
				{D5, D2, WHITE_PAWN, 0, QUIET},
				{D5, D3, WHITE_PAWN, 0, QUIET},
				{D5, D4, WHITE_PAWN, 0, QUIET},
				{D5, D6, WHITE_PAWN, 0, QUIET},
				{D5, D7, WHITE_PAWN, 0, QUIET},
				{D5, D8, WHITE_PAWN, 0, CAPTURE},
				{D5, A5, WHITE_PAWN, 0, QUIET},
				{D5, B5, WHITE_PAWN, 0, QUIET},
				{D5, C5, WHITE_PAWN, 0, QUIET},
				{D5, E5, WHITE_PAWN, 0, QUIET},
				{D5, F5, WHITE_PAWN, 0, QUIET},
				{D5, G5, WHITE_PAWN, 0, QUIET},
				{D5, H5, WHITE_PAWN, 0, QUIET},
			},
		},
	}
	for _, tt := range tests {
...
func TestGenerateKingMoves(t *testing.T) {
	tests := []struct {
		...
		{"rn1q2nr/p2kb1pp/1p6/8/4K3/2N2p1N/PPPP4/R1BQ1B1R w - - 0 14", WHITE, E4, MAX_KING_MOVES,
			[]MoveUnpacked{
				{E4, D3, WHITE_PAWN, 0, QUIET},
				{E4, D4, WHITE_PAWN, 0, QUIET},
				{E4, D5, WHITE_PAWN, 0, QUIET},
				{E4, E3, WHITE_PAWN, 0, QUIET},
				{E4, E5, WHITE_PAWN, 0, QUIET},
				{E4, F3, WHITE_PAWN, 0, CAPTURE},
				{E4, F4, WHITE_PAWN, 0, QUIET},
				{E4, F5, WHITE_PAWN, 0, QUIET},
			},
		},
		...
		{"r1bqk2r/ppp1bppp/2np1n2/6B1/4P3/2NQ4/PPP2PPP/R3KBNR w KQkq - 4 7", WHITE, E1, 4,
			[]MoveUnpacked{
				...
				{E1, D2, WHITE_PAWN, 0, QUIET},
				{E1, E2, WHITE_PAWN, 0, QUIET},
				{E1, C1, WHITE_PAWN, 0, QUEEN_CASTLE},
			},
		},
		{"r1bq1rk1/ppp1bppp/2np1n2/6B1/4P3/2NQ4/PPP2PPP/2KR1BNR w - - 6 8", WHITE, C1, 2,
			[]MoveUnpacked{
				{C1, B1, WHITE_PAWN, 0, QUIET},
				{C1, D2, WHITE_PAWN, 0, QUIET},
			},
		},
		// TODO: add illegal moves
